...
namespace BrowserLauncherApp
{
        ...
        global::Microsoft.UI.Xaml.Markup.IComponentConnector
    {
            ...
            IProcessesPage_Bindings
        {
            ...
            {
                if (lineNumber == 106 && columnNumber == 91)
                {
                    isobj7TextDisabled = true;
                }
                else if (lineNumber == 107 && columnNumber == 87)
                {
                    isobj8TextDisabled = true;
                }
                else if (lineNumber == 101 && columnNumber == 98)
                {
                    isobj9TextDisabled = true;
                }
                else if (lineNumber == 102 && columnNumber == 83)
                {
                ...
                else if (lineNumber == 98 && columnNumber == 84)
                {
                    isobj12TextDisabled = true;
                }
                else if (lineNumber == 93 && columnNumber == 85)
                {
